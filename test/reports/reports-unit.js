...
describe('Reports', () => {
    it('should get all reports', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(200, {
                ...
                data: [
                    {
                        ...
                        _links: {
                            self: {
                                href: 'https://123456789.api.checkout.com/reports/rpt_lmmldzousk7etoqijqundqexa4',
                            },
                        },
                    },
                ],
                _links: {
                    self: {
                        href: 'https://123456789.api.checkout.com/reports?entity_id=ent_znj4ih5kn4fuxiaquoudv5mvwy&created_after=2022-02-17T00:00:00.000Z&limit=5',
                    },
                    next: {
                        href: 'https://123456789.api.checkout.com/reports?pagination_token=NaZMwq3KbreYcXg0dg752Dg8ps4orkwVK9pj9WFzkXk8rPoR32Wf74QWX0EkZ&entity_id=ent_znj4ih5kn4fuxiaquoudv5mvwy&created_after=2022-02-17T00:00:00.000Z&limit=5',
                    },
                },
            });
    ...
    it('should throw auth error getting all reports', async () => {
        nock('https://123456789.api.sandbox.checkout.com').get('/reports').reply(401);
    ...
    it('should get report details', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(200, {
                ...
                _links: {
                    self: {
                        href: 'https://123456789.api.sandbox.checkout.com/reports/rpt_6spt2r7yaheutcaoo2pxplt5fq',
                    },
                },
            });
