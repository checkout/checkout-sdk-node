...
describe('Reconciliation', () => {
        ...
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(201, {
                ...
                data: {
                    ...
                    _links: {
                        payments: {
                            href: 'https://123456789.api.checkout.com/reporting/statements/190110B107654/payments',
                        },
                    },
                },
                _links: {
                    next: {
                        href: 'https://123456789.api.checkout.com/reporting/payments?from=01%2F03%2F2019%2000%3A00%3A00&to=01%2F03%2F2019%2000%3A00%3A00&limit=1&after=11111111',
                    },
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/payments?from=01%2F03%2F2019%2000%3A00%3A00&to=01%2F03%2F2019%2000%3A00%3A00&limit=1',
                    },
                },
            });
    ...
    it('should throw Not Found error when trying to get payments', async () => {
        nock('https://123456789.api.sandbox.checkout.com').get('/reporting/payments?from=test').reply(404);
        const cko = new Checkout(SK, { subdomain: '123456789' });
    ...
    it('should get JSON statements report', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(201, {
                ...
                data: [
                    {
                        ...
                        payouts: [
                            {
                                ...
                                _links: {
                                    payments: {
                                        href: 'https://123456789.api.checkout.com/reporting/statements/155613B100981/payments?payout_id=OYWDV06ZZ',
                                    },
                                    download: {
                                        href: 'https://123456789.api.checkout.com/reporting/statements/155613B100981/payments/download?payout_id=OYWDV06ZZ',
                                    },
                                },
                            },
                        ],
                        _links: {
                            payments: {
                                href: 'https://123456789.api.checkout.com/reporting/statements/155613B100981/payments',
                            },
                            download: {
                                href: 'https://123456789.api.checkout.com/reporting/statements/155613B100981/payments/download',
                            },
                        },
                    },
                ],
                _links: {
                    next: {
                        href: 'https://123456789.api.checkout.com/reporting/statements?from=01%2F01%2F2019%2000%3A00%3A00&to=01%2F11%2F2019%2000%3A00%3A00&limit=1&skip=1',
                    },
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/statements?from=01%2F01%2F2019%2000%3A00%3A00&to=01%2F11%2F2019%2000%3A00%3A00&limit=1',
                    },
                },
            });
    ...
    it('should paginate the json payment response', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(201, {
                ...
                _links: {
                    next: {
                        href: 'https://123456789.api.checkout.com/reporting/payments?from=07%2F07%2F2020%2017%3A51%3A42&to=07%2F07%2F2020%2017%3A51%3A59&after=269060358&limit=3',
                    },
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/payments?from=07%2F07%2F2020%2017%3A51%3A42&to=07%2F07%2F2020%2017%3A51%3A59&after=269060368&limit=3',
                    },
                },
                page: '269060358',
            });
    ...
    it('should get payments actions', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(200, {
                ...
                _links: {
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/actions?requested_from=08%2F17%2F2020%2016%3A48%3A52&requested_to=09%2F17%2F2020%2016%3A48%3A52&limit=200',
                    },
                },
            });
    ...
    it('should get the reconciliation data of a payment action', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(200, {
                ...
                _links: {
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/actions/act_h45qukswryqejptltkcylnwgwe',
                    },
                },
            });
        const cko = new Checkout(SK, { subdomain: '123456789' });
    ...
    it('should get payments action', async () => {
        nock('https://123456789.api.sandbox.checkout.com')
            ...
            .reply(200, {
                ...
                data: [
                    {
                        ...
                        _links: {
                            self: {
                                href: 'https://123456789.api.checkout.com/reporting/payments/pay_guvhr46cw2kurd6lknczrsh7ma',
                            },
                        },
                    },
                ],
                _links: {
                    self: {
                        href: 'https://123456789.api.checkout.com/reporting/payments/actions/act_guvhr46cw2kurd6lknczrsh7ma',
                    },
                },
            });
