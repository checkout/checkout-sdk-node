...
export function createEndpoints(config) {
    return {
        ...
        complianceRequests: new ENDPOINTS.ComplianceRequests(config),
        ...
        googlePay: new ENDPOINTS.GooglePay(config),
        ...
        onboardingSimulator: new ENDPOINTS.OnboardingSimulator(config),
